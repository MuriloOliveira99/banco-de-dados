...
*/
/*
1. Crie uma função onde possamos passar qualquer data e nos retorne o dia da semana (2a.feira, 3a.feira, ...).
*/
...
/*
2. Com a função criada, faça um SELECT em Cliente, mostrando o dia da semana em que cada cliente nasceu.
*/
...
/*
3. Com a mesma função, agrupe pelo dia da semana e veja quantos clientes nasceram em cada dia. Ordene pela quantidade de 
   forma descendente.
*/
...
/*
4. Usando a função, retorne somente os clientes que nasceram no sábado ou domingo.
*/
select	*, dbo.RetornarDiaDaSemana(dtNascimento) as DiadaSemana
from	Cliente 
...
/*
5. Crie a função fcVeiculo que traga distintamente todas as descrições dos veículos, com seus respectivos modelos e nomes dos fabricantes.
*/
...
/*
6. Crie uma função onde passando o sexo, retorne todas as informações dos clientes respectivos.
*/
select * from cliente
...
/*
7. Crie uma função onde passando o número do cliente, retorne todas as informações do cliente, as respectivas 
   vendas feitas entre 2013 e 2015 (usar tabelas Vendas2013, ...), nomes do veículo, nome do modelo, nome do Fabricante, 
   data da venda e valor do veículo.
*/
select top 1 * from Cliente
select top 1 * from Vendas2013
...
return
	...
	select	C.*, Vd.dataVenda, V.idVeiculo 
			,V.descricao as Veiculo, M.Descricao as Modelo, F.Nome as Fabricante, V.valor
...
select	* from	fcInfoVendasCliente(8)

/*
8. Crie uma função multi-statment que além de fazer o que a função anterior, adicione os campos TotalVendasVeiculo2013
   , TotalVendasVeiculo2014 e TotalVendasVeiculo2015 e os preencha com o total de vendas para o 
...
select * from Cliente
select * from fcInfoVendasClienteTotal(8)

declare @idcliente tinyint = 8
